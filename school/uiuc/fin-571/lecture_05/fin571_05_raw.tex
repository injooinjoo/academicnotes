...
\begin{tcolorbox}[mybox, title=\textbf{통화정책의 핵심 질문}]
...
\begin{tcolorbox}[warningbox, title=\textbf{주의: 모듈 1의 특성}]
...
\begin{tcolorbox}[examplebox, title=\textbf{초과 지급준비금의 기회비용 예시}]
...
\begin{tcolorbox}[mybox, title=\textbf{중앙은행의 역할}]
...
\begin{tcolorbox}[examplebox, title=\textbf{LIBOR와 연방기금 금리의 관계}]
...
\begin{tcolorbox}[examplebox, title=\textbf{명목 금리와 실질 금리 예시: 주유비}]
\begin{itemize}
...
\begin{tcolorbox}[mybox, title=\textbf{피셔 방정식}]
...
\begin{tcolorbox}[examplebox, title=\textbf{TIPS 수익률 데이터 분석}]
...
\begin{tcolorbox}[mybox, title=\textbf{다른 선진국 국채보다 미국 국채가 선호되는 이유}]
...
\begin{tcolorbox}[examplebox, title=\textbf{실제 수익률 곡선 예시: 2021년 6월 1일}]
...
\begin{tcolorbox}[summarybox, title=\textbf{수익률 곡선의 중요성}]
...
\begin{itemize}
    ...
    \item \textbf{결과:} 리저브 프라이머리 펀드는 결국 주당 1달러당 0.97달러만 돌려줄 수 있었습니다. 이 사건을 \textbf{버크 깨짐 (breaking the buck)}이라고 합니다. 머니 마켓 뮤추얼 펀드에는 예금 보험이 없으므로, 펀드가 버크를 깨면 투자자들은 돈을 잃게 됩니다.
...
\begin{tcolorbox}[summarybox, title=\textbf{리저브 프라이머리 펀드 사례의 교훈}]
...
\begin{tcolorbox}[warningbox, title=\textbf{참고: 증권화 (Securitization) 내용}]
...
\begin{tcolorbox}[summarybox, title=\textbf{모듈 1 핵심 요약: 금리 및 금융 시장}]
\begin{itemize}
...
\begin{tcolorbox}[colback=myblue!10!white, colframe=myblue!75!black, title=\textbf{문서 핵심 요약}]
...
\begin{tcolorbox}[colback=mygreen!10!white, colframe=mygreen!75!black, title=\textbf{핵심 용어 해설}]
...
\begin{tcolorbox}[colback=myorange!10!white, colframe=myorange!75!black, title=\textbf{증권화의 정의와 중요성}]
...
\begin{tcolorbox}[colback=myred!10!white, colframe=myred!75!black, title=\textbf{단일 대출의 위험}]
...
\begin{tcolorbox}[colback=myblue!10!white, colframe=myblue!75!black, title=\textbf{대출 풀의 위험 감소 효과}]
...
\begin{tcolorbox}[colback=mygreen!10!white, colframe=mygreen!75!black, title=\textbf{증권화의 핵심: 현금 흐름의 정확한 예측}]
...
\begin{tcolorbox}[colback=myorange!10!white, colframe=myorange!75!black, title=\textbf{증권의 구성과 우선순위}]
  \begin{itemize}
    \item \textbf{채권 (Bonds):}
      \begin{itemize}
...
\begin{tcolorbox}[colback=myblue!10!white, colframe=myblue!75!black, title=\textbf{증권화 수익성 예시}]
  \textbf{가정:}
  \begin{itemize}
...
\begin{tcolorbox}[colback=mygreen!10!white, colframe=mygreen!75!black, title=\textbf{증권화가 신용 공급에 미치는 영향}]
  \begin{itemize}
...
\begin{tcolorbox}[colback=myblue!10!white, colframe=myblue!75!black, title=\textbf{미국 증권화 시장의 규모와 특징}]
  \begin{itemize}
...
\begin{tcolorbox}[colback=myred!10!white, colframe=myred!75!black, title=\textbf{단기 자금 시장과 증권화의 연결고리}]
...
\begin{tcolorbox}[colback=mygreen!10!white, colframe=mygreen!75!black, title=\textbf{학습 내용 요약}]
  \begin{itemize}
