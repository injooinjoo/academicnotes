...
\begin{lstlisting}[style=pythonstyle, caption={Logistic Regression with statsmodels}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={Regularized Logistic Regression in sklearn}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={Multinomial Logistic Regression in sklearn}, breaklines=true]
from sklearn.linear_model import LogisticRegression
...
\begin{lstlisting}[style=pythonstyle, caption={One-vs-Rest Classification}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={Computing Confusion Matrix in sklearn}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={ROC Curve and AUC in sklearn}, breaklines=true]
