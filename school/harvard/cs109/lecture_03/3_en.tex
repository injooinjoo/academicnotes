...
\begin{lstlisting}[language=Python, caption={Creating a Series from a list}]
...
\begin{lstlisting}[language=Python, caption={Series attributes}]
...
\begin{lstlisting}[language=Python, caption={Custom string index}]
...
\begin{lstlisting}[language=Python, caption={DataFrame from list of dictionaries}]
data = [
...
\begin{lstlisting}[language=Python, caption={DataFrame from dictionary of lists}]
data = {
...
\begin{lstlisting}[language=Python, caption={DataFrame attributes}]
...
\begin{lstlisting}[language=Python, caption={Reading a CSV file}]
...
\begin{lstlisting}[language=Python, caption={Inspecting a DataFrame}]
...
\begin{lstlisting}[language=Python, caption={Selecting columns}]
...
\begin{lstlisting}[language=Python, caption={Using loc and iloc}]
...
\begin{lstlisting}[language=Python, caption={Creating boolean masks}]
df = pd.DataFrame({
...
\begin{lstlisting}[language=Python, caption={Filtering with boolean masks}]
...
\begin{lstlisting}[language=Python, caption={Combining conditions}]
...
\begin{lstlisting}[language=Python, caption={Sorting DataFrames}]
# Sort by one column
df.sort_values('age')
...
\begin{lstlisting}[language=Python, caption={Counting values}]
...
\begin{lstlisting}[language=Python, caption={GroupBy operations}]
# Average age by city
...
\begin{lstlisting}[language=Python, caption={Working with missing values}]
...
\begin{lstlisting}[language=Python, caption={Renaming columns}]
...
\begin{lstlisting}[language=Python, caption={Method chaining example}]
...
\begin{lstlisting}[language=Python, caption={Complete example workflow}]
# 1. Load the data
...
\begin{lstlisting}[language=Python, caption={Exploding comma-separated values}]
# Sample data
df = pd.DataFrame({
    'name': ['Alice', 'Bob'],
