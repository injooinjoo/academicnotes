...
\begin{lstlisting}[language=Python, caption={Simple Linear Regression with sklearn}, breaklines=true]
...
\begin{lstlisting}[language=Python, caption={Multiple Linear Regression}, breaklines=true]
# Multiple predictors
...
\begin{lstlisting}[language=Python, caption={Handling Categorical Variables}, breaklines=true]
import pandas as pd
