...
\begin{lstlisting}[language=Python, caption={Polynomial Regression in sklearn}, breaklines=true]
...
\begin{lstlisting}[language=Python, caption={Complete Cross-Validation Example}, breaklines=true]
