...
\begin{lstlisting}[language=Python, caption={Fetching HTML with requests}, breaklines=true]
import requests
...
\begin{lstlisting}[language=Python, caption={Parsing HTML with BeautifulSoup}, breaklines=true]
...
\begin{lstlisting}[language=Python, caption={Extracting data into a structured format}, breaklines=true]
...
\begin{lstlisting}[language=Python, caption={Creating a DataFrame}, breaklines=true]
import pandas as pd
