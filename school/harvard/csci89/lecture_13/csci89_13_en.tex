...
\begin{lstlisting}[style=pythonstyle,caption={Basic Seq2Seq Encoder-Decoder}]
...
\begin{lstlisting}[style=pythonstyle,caption={Using Hugging Face Transformers}]
...
\begin{lstlisting}[style=pythonstyle,caption={BLEU Score Calculation}]
