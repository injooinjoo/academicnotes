...
\begin{lstlisting}[caption={Regular Expression for Dates}, breaklines=true]
import re
...
\begin{lstlisting}[caption={Pattern for Names with Titles}, breaklines=true]
...
\begin{lstlisting}[caption={Pattern for Organizations}, breaklines=true]
...
\begin{lstlisting}[caption={Simple Rule-Based NER System}, breaklines=true]
import re
...
\begin{lstlisting}[caption={SpaCy NER Basics}, breaklines=true]
import spacy
...
\begin{lstlisting}[caption={Visualize NER with displacy}, breaklines=true]
...
\begin{lstlisting}[caption={SpaCy Training Data Format}, breaklines=true]
...
\begin{lstlisting}[caption={Fine-Tuning SpaCy NER}, breaklines=true]
import spacy
...
\begin{lstlisting}[caption={POS Tagging with NLTK}, breaklines=true]
import nltk
...
\begin{lstlisting}[caption={POS Tagging with SpaCy}, breaklines=true]
import spacy
...
\begin{lstlisting}[caption={NER Feature Enhancement}, breaklines=true]
import spacy
import pandas as pd
...
\begin{lstlisting}[caption={Binary Entity Indicators}, breaklines=true]
