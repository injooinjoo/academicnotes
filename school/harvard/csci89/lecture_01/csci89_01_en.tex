...
\begin{lstlisting}[style=pythonstyle, caption={Building a Neural Network in Keras}, breaklines=true]
import keras
...
\begin{lstlisting}[style=pythonstyle, caption={Specifying Loss and Optimizer in Keras}, breaklines=true]
model.compile(
...
\begin{lstlisting}[style=pythonstyle, caption={Using Different Optimizers in Keras}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={Complete Neural Network Training Example}, breaklines=true]
import keras
from keras import models, layers
