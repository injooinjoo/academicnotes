...
\begin{lstlisting}[style=pythonstyle, caption={t-Test Feature Selection}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={Simple RNN in Keras}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={Bidirectional LSTM}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={RNN with Dropout}, breaklines=true]
