...
\begin{lstlisting}[caption={Naive Bayes for Text Classification}]
...
\begin{lstlisting}[caption={KNN for Text Classification}]
...
\begin{lstlisting}[caption={Logistic Regression for Text}]
...
\begin{lstlisting}[caption={SVM for Text Classification}]
...
\begin{lstlisting}[caption={Random Forest for Text}]
...
\begin{lstlisting}[caption={Pipeline with Cross-Validation}]
