...
\begin{lstlisting}[language=Python, caption=NLTK를 사용한 단어 토큰화]
import nltk
...
\begin{lstlisting}[language=Python, caption=Porter 및 Snowball Stemmer 적용]
...
\begin{lstlisting}[language=Python, caption=SpaCy를 사용한 표제어 추출]
import spacy
