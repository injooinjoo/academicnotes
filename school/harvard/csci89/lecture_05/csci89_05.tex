...
\hypersetup{
    pdftitle={CSCI E-89: Introduction to Artificial Intelligence - Module 05},
    pdfauthor={강의 노트},
...
\begin{itemize}
    ...
    \item \textbf{\texttt{token_pattern} 변경:} 기본 \texttt{token\_pattern}은 두 글자 이상의 단어만 인식하므로, 'a'와 같은 단어를 포함시키기 위해 \texttt{r'(?u)\textbackslash{}b\textbackslash{}w+\textbackslash{}b'}로 변경했습니다.
