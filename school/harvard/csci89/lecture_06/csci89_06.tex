...
\begin{lstlisting}[caption={Character-level tokenization and padding}, label=lst:char_preprocess]
import numpy as np
...
\begin{lstlisting}[caption={Building and training a model with character embeddings}, label=lst:char_model]
...
\begin{lstlisting}[caption={Visualizing codings with t-SNE}, label=lst:tsne]
...
\begin{lstlisting}[caption={Applying L1 Activity Regularization}, label=lst:l1_reg]
