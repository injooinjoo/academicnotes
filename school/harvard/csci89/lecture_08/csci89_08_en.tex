...
\begin{lstlisting}[style=rstyle, caption={STM Workflow in R}]
# Install and load
...
\begin{lstlisting}[style=rstyle, caption={Summarize and plot topics}]
# Summary of topics
summary(stm_model)
...
\begin{lstlisting}[style=rstyle, caption={Find representative documents}]
...
\begin{lstlisting}[style=rstyle, caption={Estimate and plot effects}]
...
\begin{lstlisting}[style=rstyle, caption={Topic prevalence over time}]
...
\begin{lstlisting}[style=rstyle, caption={Search for optimal K}]
...
\begin{lstlisting}[style=rstyle, caption={Extract and plot coherence/exclusivity}]
# Extract metrics
...
\begin{lstlisting}[style=rstyle, caption={Visualize topic correlations}]
...
\begin{lstlisting}[style=rstyle, caption={Select best model from multiple runs}]
