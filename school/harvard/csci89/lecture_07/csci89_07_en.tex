...
\begin{lstlisting}[caption={LDA with scikit-learn}, breaklines=true]
...
\begin{lstlisting}[caption={Display top words for each topic}, breaklines=true]
...
\begin{lstlisting}[caption={Find most representative documents}, breaklines=true]
...
\begin{lstlisting}[caption={NMF in Python}, breaklines=true]
...
\begin{lstlisting}[caption={Coherence calculation with gensim}, breaklines=true]
...
\begin{lstlisting}[caption={LDA in R}, language=R, breaklines=true]
