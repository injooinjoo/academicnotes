...
\begin{lstlisting}[language=Python, caption={Python scikit-learn을 이용한 LDA 구현}, label={lst:lda_python}]
...
\begin{lstlisting}[language=Python, caption={Python scikit-learn을 이용한 NMF 구현}, label={lst:nmf_python}]
from sklearn.feature_extraction.text import CountVectorizer
...
\begin{lstlisting}[language=R, caption={R을 이용한 LDA 구현}, label={lst:lda_r}]
# install.packages("tm")
