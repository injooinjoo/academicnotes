...
\begin{itemize}
    ...
    \item \textbf{실전 사례 (사기 탐지):} 15ms의 응답 속도와 초당 5만 건의 트래픽을 처리하는 실시간 사기 탐지 시스템을 구축하기 위해, **람다(Lambda) 아키텍처**, **순환 버퍼(Circular Buffer)**, **Cassandra** 저장소 등 고성능 엔지니어링 기술이 어떻게 적용되었는지 살펴봅니다.
\end{itemize}
\end{summary_box}
