...
\begin{lstlisting}[style=sqlstyle, caption={Creating a Column Masking Function}]
...
RETURN
    CASE
        ...
        WHEN is_account_group_member('analyst_group') THEN CONCAT('***-**-', RIGHT(ssn, 4))
        ELSE '***-**-****'
    END;
...
\begin{lstlisting}[style=sqlstyle, caption={Creating a Federated Connection}]
