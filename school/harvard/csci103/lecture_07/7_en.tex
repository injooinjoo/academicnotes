...
\begin{lstlisting}[style=sqlstyle, caption={DLT SQL Examples}, breaklines=true]
...
\begin{lstlisting}[style=pythonstyle, caption={DLT CDC Pipeline Example}, breaklines=true]
import dlt
...
\begin{lstlisting}[style=pythonstyle, caption={DLT Expectations Example}, breaklines=true]
import dlt
