...
\begin{lstlisting}[style=sqlstyle, caption={Creating a Partitioned Table}]
CREATE TABLE sales (
    id INT,
    amount DECIMAL,
    sale_date DATE,
...
\begin{lstlisting}[style=sqlstyle, caption={OPTIMIZE with Z-Ordering}]
...
\begin{lstlisting}[style=pythonstyle, caption={Forcing Broadcast Join}]
...
\begin{lstlisting}[style=sqlstyle, caption={SCD Type 1: Simple Update}]
UPDATE customers
...
\begin{lstlisting}[style=sqlstyle, caption={SCD Type 2: Historical Record}]
-- Old record
...
\begin{lstlisting}[style=sqlstyle, caption={MERGE for Upsert Operations}]
...
\begin{lstlisting}[style=sqlstyle, caption={OPTIMIZE Command}]
...
\begin{lstlisting}[style=sqlstyle, caption={VACUUM Command}]
...
\begin{lstlisting}[style=sqlstyle, caption={Time Travel Queries}]
...
\begin{lstlisting}[style=sqlstyle, caption={Clone Operations}]
