...
\begin{titlepage}
    \centering
    \vspace*{\stretch{1}}
    {\Huge\bfseries CSCI E-103: 데이터 엔지니어링\par}
    \vspace{1cm}
    {\LARGE 4강: 데이터 변환 (Data Transformations)\par}
    \vspace{2cm}
    {\Large Anindita Mahapatra \& Eric Gieseke\par}
    \vspace{0.5cm}
    {\large Harvard Extension, Fall 2025\par}
    \vspace*{\stretch{2}}
    {\large \today\par}
\end{titlepage}
