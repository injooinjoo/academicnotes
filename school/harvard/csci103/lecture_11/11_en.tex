...
\begin{lstlisting}[style=sqlstyle, caption={Genie-Generated SQL Example}]
...
\begin{lstlisting}[style=sqlstyle, caption={AI Functions in SQL}]
...
\begin{lstlisting}[style=sqlstyle, caption={UC Function as Agent Tool}]
...
\begin{lstlisting}[style=pythonstyle, caption={Setting Up the Data}]
