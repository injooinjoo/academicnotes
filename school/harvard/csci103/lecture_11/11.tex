...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item 이 숫자를 **Vector DB**에 저장합니다. (유사도 검색을 위해)
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item 찾아낸 문서 조각을 **프롬프트에 붙여서** LLM에게 보냅니다.
...
\begin{lstlisting}[caption={AI Functions 활용 예시}, label={lst:aifunc}]
...
최근 기업은 **ESG(환경, 사회, 지배구조)** 관점에서 AI를 평가합니다. 
