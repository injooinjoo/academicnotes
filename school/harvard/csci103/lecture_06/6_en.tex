...
\begin{lstlisting}[style=sqlstyle, caption={Creating a Streaming Table from Cloud Storage}, breaklines=true]
...
\begin{lstlisting}[style=sqlstyle, caption={Creating a Materialized View}, breaklines=true]
...
\begin{lstlisting}[style=sqlstyle, caption={Using ai\_query() for Product Marketing}, breaklines=true]
SELECT
  sku_id,
  product_name,
  ai_query(
...
\begin{lstlisting}[style=sqlstyle, caption={Built-in AI Functions}, breaklines=true]
-- Sentiment Analysis
