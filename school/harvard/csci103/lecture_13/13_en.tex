...
\begin{lstlisting}[style=yamlstyle, caption={Terraform Example: Databricks Workspace}]
...
\begin{lstlisting}[style=bashstyle, caption={Terraform Workflow}]
...
\begin{lstlisting}[style=sqlstyle, caption={Querying System Tables for Cost Analysis}]
...
\begin{lstlisting}[style=sqlstyle, caption={Using Lineage for Impact Analysis}]
...
\begin{lstlisting}[style=pythonstyle, caption={DQX Quality Rules Example}]
...
\begin{lstlisting}[style=yamlstyle, caption={Example databricks.yml}]
bundle:
  name: my_project
...
\begin{lstlisting}[style=bashstyle, caption={DAB CLI Commands}]
...
\begin{lstlisting}[style=yamlstyle, caption={Azure DevOps Pipeline with DABs}]
# .azure-pipelines.yml
trigger:
  - main
