...
\begin{lstlisting}[language=Python, caption={Python으로 CSV 파일 읽고 DataFrame 생성하기}, label={lst:python_read}]
...
\begin{lstlisting}[language=SQL, caption={SQL로 테이블 조회하기}, label={lst:sql_read}]
