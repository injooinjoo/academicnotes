...
\begin{lstlisting}[style=pythonstyle, caption={Basic Data Profiling in Spark}]
# Quick statistics
df.describe().show()
...
\begin{lstlisting}[style=pythonstyle, caption={Loading and Preparing Housing Data}]
...
\begin{lstlisting}[style=pythonstyle, caption={Linear Regression with scikit-learn}]
