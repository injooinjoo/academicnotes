...
\begin{lstlisting}[style=sqlstyle, caption={Lakebase PostgreSQL Connection}]
...
\begin{lstlisting}[style=pythonstyle, caption={Simple Streamlit App Example}]
...
\begin{lstlisting}[style=sqlstyle, caption={AI Parse Document Example}]
...
\begin{lstlisting}[style=sqlstyle, caption={Multimodal AI Query}]
...
\begin{lstlisting}[style=pythonstyle, caption={Partition Operations}]
...
\begin{lstlisting}[style=pythonstyle, caption={Common DataFrame Gotchas}]
...
\begin{lstlisting}[style=sqlstyle, caption={Generated Always As}]
...
\begin{lstlisting}[style=sqlstyle, caption={MERGE for SCD Type 1 with Condition}]
...
\begin{lstlisting}[style=pythonstyle, caption={Streaming Trigger Options}]
...
\begin{lstlisting}[style=pythonstyle, caption={Streaming with Checkpoint}]
stream = (
    spark.readStream
    .format("kafka")
...
\begin{lstlisting}[style=pythonstyle, caption={Kafka Stream Processing}]
...
\begin{lstlisting}[style=pythonstyle, caption={AutoLoader Example}]
...
\begin{lstlisting}[style=pythonstyle, caption={Optuna for Hyperparameter Tuning}]
import optuna
