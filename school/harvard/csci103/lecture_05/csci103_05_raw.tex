...
\lstset{
  ...
  numbersep=6pt,
  frame=single,
  captionpos=b, % 캡션 위치를 아래로
  aboveskip=1em, % 코드 블록 위 여백
  belowskip=1em, % 코드 블록 아래 여백
  xleftmargin=0.5em, % 왼쪽 여백
  xrightmargin=0.5em, % 오른쪽 여백
  showstringspaces=false, % 문자열 내 공백 표시 안 함
  commentstyle=\color{gray}, % 주석 색상
  keywordstyle=\color{blue}, % 키워드 색상
  stringstyle=\color{red}, % 문자열 색상
  identifierstyle=\color{black}, % 식별자 색상
  morekeywords={SELECT, FROM, WHERE, GROUP, BY, ORDER, INSERT, INTO, VALUES, DELETE, UPDATE, MERGE, USING, ON, WHEN, MATCHED, NOT, THEN, CREATE, TABLE, AS, DESCRIBE, DETAIL, FORMAT, DELTA, APPEND, MODE, VERSION, AS, OF, READ, STREAM, WRITE, STREAM, TRIGGER, FOREACH, BATCH, START, QUERY, STOP, WITH, OPTIONS, SET, OPTION, DROP, IF, EXISTS, SHOW, HISTORY, ALTER, ADD, COLUMN, CAST, DISPLAY, DATABRICKS, UTILS, WIDGETS, GET, PARAM, JOB, PARAM, PRINT, SPARK, READ, PARQUET, STREAM, COUNT, STATE, LOAN_STATUS, TEMP, VIEW, MAP, CHLOROPLETH, USPS, LOAN_COUNT, VISUALIZATION, ADD, PLUS, CHOOSE, TYPE, WORLD, UNITED, STATES, COLUMN, FIELD, HOVER, DARKER, COLORS, REFER, MORE, DATA, HOLE, EMPTY, HYDRATING, CELL, PREVIOUSLY, EMPTY, EXPECT, BATCH, OPERATIONS, DISTINCT, LOOP, SLEEPS, TIME, CONVINCE, ACTUALLY, GONE, FAIL, SUPPORT, GDPR, SCENARIOS, NEEDLE, HAYSTACK, FILE, PARTITION, DROP, ENTIRE, MAKE, EDIT, RECOMPUTE, EXPENSIVE, LONG, MUCH, CLEAR, ROW, EDITS, UPSERT, ATOMIC, GRAPHICS, SEVEN, STEPS, NECESSARY, TRADITIONALLY, ATOMIC, OPERATIONS, PORTION, SAMPLE, SIMULATE, CHANGE, RECORD, HOLE, OREGON, AFFECTED, UPDATED, INSERTED, DELETED, PER, SE, ORIGVE, OBVIOUS, SCHEMA, EVOLUTION, RANDOM, BIG, CAST, FICTITIOUS, AMOUNT, APPEND, MODE, FAIL, MERGE, SCHEMA, TRUE, IDEALLY, SILENTLY, WRITING, SAME, TABLE, ADDITIONAL, COLUMN, STILL, BEAR, ME, BETTER, RESOLVED, LOOK, SKIP, SECTION, ALTOGETHER, TIME, TRAVEL, TIMESTAMP, VERSION, NUMBER, HISTORY, MULTIPLE, VERSIONS, STARTED, CREATE, WROTE, SIX, TIMES, FINE, GRAIN, DELETE, UPDATE, MERGE, MESSED, STATEMENTS, SHOW, ERROR, KNOW, THESE, TIMESTAMPS, SELECT, COIL, BACK, EXPECT, HOLE, FAIR, SURE, ENOUGH, POPULATED, VALUE, DELETED, PROVES, INDEED, DATE, APPROXIMATE, NEXT, WORKFLOW, JOBS, PIPELINES, ETL, DLT, INJECTION, POPULAR, DATABASES, APPS, WORKDAY, SALESFORCE, RUNNING, BEFORE, CLASS, FAILURE, RUN, ID, START, TIME, FAILED, TRIED, THREE, VARIATIONS, CODE, SUCCEEDED, AGAIN, ONCE, QUEUE, CONCURRENCY, ONE, CUED, TASKS, DEPENDENCY, NEW, NOTEBOOK, PYTHON, SCRIPT, SQL, QUERY, FILE, JAR, WHEEL, STICK, BASIC, ADDING, NAME, DEPENDS, NOT, ALREADY, TWO, PATH, WORKSPACE, PARAMETER, PASS, ENVIRONMENT, PROD, DEV, REMAINS, CONFIGURATION, NOTIFICATIONS, RETRIES, METRICS, INCREASE, SIMULTANEOUSLY, SCHEDULES, CRON, STYLE, SYNTAX, PLAY, AROUND, FILE, ARRIVAL, CONTINUOUS, TRIGGER, OPTIONS, JOB, PARAMETERS, TASK, KEYS, DIFFERENT, PARAM, JV, M1, CLICK, HELLO, PYTHON, NOTEBOOK, DBUTILS, WIDGETS, GET, PARAM, PRINT, WRITTEN, SIMILARLY, GET, JOB, PARAM, PRINT, SLIGHTLY, CONCEPTS, PASSED, WORKFLOW, JOB, TASK, SIMPLE, SQL, SELECT, HELLO, NODE, SCALA, DBT, WHEEL, DASHBOARD, QUERY, BUILT, BURNING, PARALLEL, REMOVE, SIMULTANEOUSLY, COPY, INTO, OBVIOUS, ERROR, CONTINUE, BAD, RECORDS, MILLION, SUCCEEDED, SKIP, PAST, LOAD, REST, DEFINED, INCOMING, COMPLYING, FLOAT, EXPECTING, INT, ABSOLUTELY, UNLESS, STRING, SECOND, CONVERT, RULES, VIOLATED, FAIL, STOP, ALLOW, GUILTY, OVER, GREAT, DISCUSSION, PERSONAL, QUESTION, END, TONIGHT, OTHERS, DROP, STOP, RECORDING}
}
...
\hypersetup{
  ...
  filecolor=magenta,
  urlcolor=cyan,
  pdftitle={CSCI103 Lecture 5: 데이터 레이크하우스와 델타 레이크},
...
\fancyhead[L]{CSCI103 Lecture 5: 데이터 레이크하우스와 델타 레이크} % 왼쪽 헤더
...
FROM parquet.`/databricks-datasets/samples/lending_club/parquet/`
GROUP BY state;
