...
\begin{lstlisting}[style=sqlstyle, caption={Creating a Delta table from Parquet data}]
...
\begin{lstlisting}[style=pythonstyle, caption={Reading Delta table as a stream}]
...
\begin{lstlisting}[style=sqlstyle, caption={Batch inserts while streaming is active}]
...
\begin{lstlisting}[style=sqlstyle, caption={Row-level delete operation}]
...
\begin{lstlisting}[style=sqlstyle, caption={MERGE operation for upserting data}]
...
\begin{lstlisting}[style=pythonstyle, caption={Enabling schema evolution during write}]
...
\begin{lstlisting}[style=sqlstyle, caption={Viewing table history and time travel}]
