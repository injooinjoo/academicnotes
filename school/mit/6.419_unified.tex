...
%=======================================================================
% Lecture 1: MIT 6.419x: 고차원의 바다를 항해하는 법
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 사막에서 바늘 찾기}]
...
\begin{conceptbox}[title={개념 2: 공분산 행렬을 만들지 마라}]
...
\begin{conceptbox}[title={개념 3: 거리표로 지도 복원하기}]
...
\begin{conceptbox}[title={개념 4: 구겨진 종이 펴기 \& 거리두기}]
...
\begin{storybox}[title={Scenario: 유저 행동 패턴 시각화}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 1 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 2: MIT 6.419x: 연결과 계층의 발견
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 둥근 구멍에 네모난 못}]
...
\begin{conceptbox}[title={개념 2: 다리 끊기 (Graph Cut)}]
...
\begin{conceptbox}[title={개념 3: 족보 만들기 (Family Tree)}]
...
\begin{storybox}[title={Scenario: 적대 길드와 동맹 길드 파악}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 1 (Part B) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 3: MIT 6.419x: 우연을 걸러내는 기술
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 로또 당첨의 함정}]
...
\begin{conceptbox}[title={개념 2: 철통 보안 검색대}]
...
\begin{conceptbox}[title={개념 3: 섞여도 괜찮아, 비율만 맞춰}]
...
\begin{storybox}[title={Scenario: 수만 개의 화합물 스크리닝}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 1 (Part C) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 4: MIT 6.419x: 네트워크의 권력자들
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 마당발 (The Popular Kid)}]
...
\begin{conceptbox}[title={개념 2: 문지기 (The Gatekeeper / Broker)}]
...
\begin{conceptbox}[title={개념 3: 유유상종 (The Influencer)}]
...
\begin{conceptbox}[title={개념 4: 구글을 만든 알고리즘 (The Authority)}]
...
\begin{storybox}[title={Scenario: 길드장과 숨은 실세 찾기}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 2 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 5: MIT 6.419x: 네트워크의 파벌 찾기
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 학교 식당 풍경}]
...
\begin{conceptbox}[title={개념 2: 우연을 가장한 필연 찾기}]
...
\begin{conceptbox}[title={개념 3: 그래프를 수직선 위에 줄 세우기}]
...
\begin{storybox}[title={Scenario: 넥슨 게임 내 '작업장' 길드 색출}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 2 (Part B) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 6: MIT 6.419x: 세상은 어떻게 연결되는가
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 눈 감고 선 긋기}]
...
\begin{conceptbox}[title={개념 2: 유유상종의 수학화}]
...
\begin{conceptbox}[title={개념 3: 좁은 세상 속 거인들}]
...
\begin{conceptbox}[title={핵심: 척도 없는 네트워크 (Scale-free)}]
...
\begin{storybox}[title={Scenario: 신작 게임 마케팅 예산 분배}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 2 (Part C) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 7: MIT 6.419x: 시간의 패턴을 읽다
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 양파 껍질 벗기기}]
...
\begin{conceptbox}[title={개념 2: 관성(Inertia)과 충격(Shock)}]
...
\begin{conceptbox}[title={개념 3: 네비게이션의 원리}]
...
\begin{storybox}[title={Scenario 1: 주말 이벤트 효과 분석 (Decomposition)}]
...
\begin{storybox}[title={Scenario 2: 매치메이킹 시스템 (Kalman Filter)}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 3 (Part A) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 8: MIT 6.419x: 지도의 빈칸을 채우다
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 함수의 확률 분포}]
...
\begin{conceptbox}[title={개념 2: 지능적인 가중 평균}]
...
\begin{conceptbox}[title={개념 3: 공간의 질감(Texture) 정의하기}]
...
\begin{storybox}[title={Scenario: 전 세계 유저들의 네트워크 품질 추정}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 3 (Part B) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 9: MIT 6.419x: 데이터 과학의 성배
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 보기만 하는 것 vs 행동하는 것}]
...
\begin{conceptbox}[title={개념 2: 가지 않은 길 (The Road Not Taken)}]
...
\begin{conceptbox}[title={개념 3: 비교할 수 없는 것을 비교하지 마라}]
...
\begin{storybox}[title={Scenario: 월정액 상품이 진짜 돈을 벌어줄까?}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 4 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 10: MIT 6.419x: 실험 없이 원인을 찾다
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 통계의 착시 현상}]
...
\begin{conceptbox}[title={개념 2: 도플갱어 찾기}]
...
\begin{conceptbox}[title={개념 3: 자연 실험(Natural Experiment) 이용하기}]
...
\begin{conceptbox}[title={개념 4: 깻잎 한 장 차이}]
...
\begin{storybox}[title={Scenario: PC방 혜택이 진짜 접속 시간을 늘릴까?}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 4 (Part B) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 11: MIT 6.419x: 보는 눈과 거르는 체
%=======================================================================
...
\begin{conceptbox}[title={개념 1: AI가 보기 좋게 차려주기}]
...
\begin{conceptbox}[title={개념 2: 기억해서 그려보기}]
...
\begin{conceptbox}[title={개념 3: 모르는 건 못 그린다}]
...
\begin{storybox}[title={Scenario 1: 불건전 프로필 이미지 필터링 (CNN)}]
...
\begin{storybox}[title={Scenario 2: 작업장(매크로) 탐지 (Autoencoder)}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 5 (Part A) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 12: MIT 6.419x: 관계를 학습하다
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 줄을 설 수 없는 데이터}]
...
\begin{conceptbox}[title={개념 2: 소문 퍼뜨리기 (Gossip)}]
...
\begin{conceptbox}[title={개념 3: GNN의 진화}]
...
\begin{storybox}[title={Scenario 1: 차세대 게임 추천 시스템 (Link Prediction)}]
...
\begin{storybox}[title={Scenario 2: 작업장 탐지 (Node Classification)}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Module 5 (Part B) 핵심 요약}]
\begin{itemize}
