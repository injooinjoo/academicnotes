...
%=======================================================================
% Lecture 1: MIT 18.6501: 통계학의 수학적 기초
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 통계적 모델이란 무엇인가?}]
...
\begin{warningbox}[title={오해 방지: 잘 정의된 모델(Well-specified)이란?}]
...
\begin{conceptbox}[title={개념 2: 이 모델로 정답을 찾을 수 있는가?}]
...
\begin{conceptbox}[title={개념 3: 관점의 대전환}]
...
%=======================================================================
% Lecture 2: MIT 18.6501: 통계적 추론의 핵심
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 추정량은 숫자가 아니라 '함수'이자 '확률변수'다}]
...
\begin{conceptbox}[title={개념 2: 가장 그럴듯한 범인 찾기}]
...
\begin{conceptbox}[title={개념 3: 평균을 평균에 맞춘다}]
...
\begin{warningbox}[title={MLE vs MoM: 누가 더 좋은가?}]
...
\begin{conceptbox}[title={개념 4: Bias-Variance Trade-off}]
...
\begin{storybox}[title={Scenario: 유저들의 불만}]
...
%=======================================================================
% Lecture 3: MIT 18.6501: 무한한 데이터의 힘
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 좋은 추정량의 최소 자격 요건}]
...
\begin{conceptbox}[title={개념 2: 모든 길은 정규분포로 통한다}]
...
\begin{conceptbox}[title={개념 3: 추정 정밀도의 물리적 한계선}]
...
\begin{conceptbox}[title={개념 4: 함수를 통과한 추정량의 분포}]
...
\begin{storybox}[title={Scenario: 대규모 업데이트의 성패}]
...
%=======================================================================
% Lecture 4: MIT 18.6501: 불확실성의 수치화
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 움직이는 것은 '고리(구간)'이지 '기둥(참값)'이 아니다}]
...
\begin{warningbox}[title={오개념 주의: Frequentist View}]
...
\begin{conceptbox}[title={개념 2: 정규분포를 역이용하여 구간 만들기}]
...
\begin{conceptbox}[title={개념 3: 잘 모를 땐 최악의 상황을 가정하라}]
...
\begin{storybox}[title={Scenario: 웹사이트 배너 클릭률 비교}]
...
%=======================================================================
% Lecture 5: MIT 18.6501: 의사결정의 수학적 최적화
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 법정 공방 (Courtroom Trial)}]
...
\begin{conceptbox}[title={개념 2: 억울한 누명 vs 범인 놓침}]
...
\begin{conceptbox}[title={개념 3: 제약 조건 하의 최적화}]
...
\begin{conceptbox}[title={개념 4: 증거의 강도(Strength of Evidence)}]
...
\begin{storybox}[title={Scenario: 업데이트 효과 검증}]
...
%=======================================================================
% Lecture 6: MIT 18.6501: 최적의 검정 레시피
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 가장 강력한 검정(UMP)을 만드는 레시피}]
...
\begin{conceptbox}[title={개념 2: 만능열쇠 (Universal Key)}]
...
\begin{conceptbox}[title={개념 3: 우도 산(Mountain) 등반하기}]
...
\begin{conceptbox}[title={개념 4: 모르는 게 있으면 꼬리가 두꺼워진다}]
...
\begin{storybox}[title={Scenario: 카지노의 의심}]
...
%=======================================================================
% Lecture 7: MIT 18.6501: 모델 자체에 대한 의심
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 연속을 이산으로 (Discretization)}]
...
\begin{conceptbox}[title={개념 2: 현실(Observed)과 이론(Expected)의 거리}]
...
\begin{conceptbox}[title={개념 3: 옷을 몸에 맞췄다면, 심사 기준을 높여라}]
...
\begin{storybox}[title={Scenario: 유저들의 봉기}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 7 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 8: MIT 18.6501: 설명에서 예측으로
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 행렬로 세상을 표현하다}]
...
\begin{conceptbox}[title={개념 2: 오차의 제곱을 최소화하라}]
...
\begin{conceptbox}[title={개념 3: 그림자 놀이}]
...
\begin{conceptbox}[title={개념 4: 왜 하필 LSE인가?}]
...
\begin{warningbox}[title={코크란의 정리 (Cochran's Theorem)}]
...
\begin{storybox}[title={Scenario: 새로운 드라마의 성공 예측}]
...
%=======================================================================
% Lecture 9: MIT 18.6501: 모든 데이터를 위한 통계
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 통계학의 만능 플랫폼}]
...
\begin{conceptbox}[title={개념 2: 무한의 세계와 유한의 세계를 잇다}]
...
\begin{conceptbox}[title={개념 3: 산을 오르는 반복적인 걸음}]
...
\begin{storybox}[title={Scenario: GPA와 합격률의 관계}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 9 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 10: MIT 18.6501: 가정을 버리고 데이터 그대로
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 디지털 모자이크}]
...
\begin{conceptbox}[title={개념 2: 벽돌 대신 모래를 쌓자}]
...
\begin{conceptbox}[title={개념 3: 너무 섬세해도, 너무 둔감해도 안 된다}]
...
\begin{conceptbox}[title={개념 4: 중용(Golden Mean)을 찾아서}]
...
\begin{storybox}[title={Scenario: 평균의 함정 탈출}]
...
%=======================================================================
% Lecture 11: MIT 18.6501: 데이터의 본질을 찾아서
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 심장 박동기 모니터}]
...
\begin{conceptbox}[title={개념 2: 럭비공 돌리기}]
...
\begin{conceptbox}[title={개념 3: 모든 것은 고유값 문제로 통한다}]
...
\begin{conceptbox}[title={개념 4: 정보의 압축}]
...
\begin{storybox}[title={Scenario: 너무 많은 게임 지표들}]
...
%=======================================================================
% Lecture 12: MIT 18.6501: 빅데이터의 딜레마와 돌파구
%=======================================================================
...
\begin{conceptbox}[title={개념 1: 식보다 미지수가 많다}]
...
\begin{conceptbox}[title={개념 2: 오컴의 면도날 (Occam's Razor)}]
...
\begin{conceptbox}[title={개념 3: 벌점(Penalty) 시스템}]
...
\begin{conceptbox}[title={개념 4: 둥근 원과 뾰족한 마름모}]
...
\begin{conceptbox}[title={개념 5: 신(Oracle)과의 대결}]
...
\begin{storybox}[title={Scenario: 이탈 유저를 찾아라}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 12 핵심 요약}]
\begin{itemize}
