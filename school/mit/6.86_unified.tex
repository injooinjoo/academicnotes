%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 6.86: Introduction to Machine Learning - 통합본
% 자동 생성됨
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{\textbf{6.86: Introduction to Machine Learning}}
\author{통합 강의 노트}
\date{}
...
%=======================================================================
% Lecture 1: MIT 6.86x: 예측의 미학
%=======================================================================
\chapter{MIT 6.86x: 예측의 미학}
\label{ch:lecture1}
...
\begin{conceptbox}[title={개념 1: 함수 근사 (Function Approximation)}]
...
\begin{conceptbox}[title={개념 2: 수색 범위 설정}]
...
\begin{conceptbox}[title={개념 3: 정답지의 유무}]
...
\begin{conceptbox}[title={개념 4: 머신러닝의 존재 이유}]
...
\begin{storybox}[title={Scenario: 완벽한 예측 모델의 함정}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 1 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 2: MIT 6.86x: 딥러닝의 시작점
%=======================================================================
\chapter{MIT 6.86x: 딥러닝의 시작점}
\label{ch:lecture2}
...
\begin{conceptbox}[title={개념 1: 공간을 가르는 칼}]
...
\begin{conceptbox}[title={개념 2: 실수에서 배운다 (Mistake Driven)}]
...
\begin{conceptbox}[title={개념 3: 벡터의 회전}]
...
\begin{conceptbox}[title={개념 4: 자 하나로 가를 수 있는가?}]
...
\begin{conceptbox}[title={개념 5: 언제 끝나는가?}]
...
\begin{storybox}[title={Scenario: 초기 스팸 필터}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 2 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 3: MIT 6.86x: 가장 안전한 경계선
%=======================================================================
\chapter{MIT 6.86x: 가장 안전한 경계선}
\label{ch:lecture3}
...
\begin{conceptbox}[title={개념 1: 턱걸이는 인정하지 않는다}]
...
\begin{conceptbox}[title={개념 2: 도로 확장 공사}]
...
\begin{conceptbox}[title={개념 3: 융통성 있는 보안관}]
...
\begin{storybox}[title={Scenario: 넥슨 카트라이더 자율주행 모드}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 3 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 4: MIT 6.86x: 가장 낮은 곳을 향하여
%=======================================================================
\chapter{MIT 6.86x: 가장 낮은 곳을 향하여}
\label{ch:lecture4}
...
\begin{conceptbox}[title={개념 1: 안개 낀 산에서 내려오기}]
...
\begin{conceptbox}[title={개념 2: 술 취한 사람의 귀가}]
...
\begin{conceptbox}[title={개념 3: 멈추는 법을 배워라}]
...
\begin{storybox}[title={Scenario: 수억 명의 시청 기록 학습}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 4 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 5: MIT 6.86x: 데이터를 조각하는 기술
%=======================================================================
\chapter{MIT 6.86x: 데이터를 조각하는 기술}
\label{ch:lecture5}
...
\begin{conceptbox}[title={개념 1: 직선의 한계}]
...
\begin{conceptbox}[title={개념 2: 차원 띄우기 (Lifting)}]
...
\begin{conceptbox}[title={개념 3: 곱셈으로 특징 만들기}]
...
\begin{conceptbox}[title={개념 4: 공짜 점심은 없다}]
...
\begin{warningbox}[title={커널 트릭 (Kernel Trick) 예고}]
...
\begin{storybox}[title={Scenario: 넥슨 FPS 게임 '서든어택'의 에임봇 탐지}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 2 (Part B) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 6: MIT 6.86x: 차원의 저주를 피하는 지름길
%=======================================================================
\chapter{MIT 6.86x: 차원의 저주를 피하는 지름길}
\label{ch:lecture6}
...
\begin{conceptbox}[title={개념 1: 관점의 전환}]
...
\begin{conceptbox}[title={개념 2: 웜홀(Wormhole) 타기}]
...
\begin{conceptbox}[title={개념 3: 무한 차원의 마법}]
...
\begin{conceptbox}[title={개념 4: 휘어지는 경계선}]
...
\begin{storybox}[title={Scenario: 인간과 봇의 움직임 구분}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 6 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 7: MIT 6.86x: 뇌를 모방하다
%=======================================================================
\chapter{MIT 6.86x: 뇌를 모방하다}
\label{ch:lecture7}
...
\begin{conceptbox}[title={개념 1: 정보의 조립 라인}]
...
\begin{conceptbox}[title={개념 2: 선형 + 선형 = 선형}]
...
\begin{conceptbox}[title={개념 3: 문제 유형에 따른 마무으리}]
...
\begin{storybox}[title={Scenario: 뉴비에게 딱 맞는 직업은?}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 3 (Part A) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 8: MIT 6.86x: 오차를 통해 배우다
%=======================================================================
\chapter{MIT 6.86x: 오차를 통해 배우다}
\label{ch:lecture8}
...
\begin{conceptbox}[title={개념 1: 책임 소재 따지기 (The Blame Game)}]
...
\begin{conceptbox}[title={개념 2: 채점 기준표}]
...
\begin{warningbox}[title={왜 분류 문제에 MSE를 안 쓰나요?}]
...
\begin{conceptbox}[title={개념 3: 시작이 반이다}]
...
\begin{conceptbox}[title={개념 4: 흔들리지 않는 편안함}]
...
\begin{storybox}[title={Scenario: VIP 유저가 떠나는 이유 찾기}]
...
%=======================================================================
% Lecture 9: MIT 6.86x: 컴퓨터가 세상을 보는 법
%=======================================================================
\chapter{MIT 6.86x: 컴퓨터가 세상을 보는 법}
\label{ch:lecture9}
...
\begin{conceptbox}[title={개념 1: 도장 찍기 (Sliding Window)}]
...
\begin{conceptbox}[title={개념 2: 요약 노트 만들기}]
...
\begin{conceptbox}[title={개념 3: 샌드위치 구조}]
...
\begin{storybox}[title={Scenario: 수만 개의 아이콘 정리하기}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 3 (Part B) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 10: MIT 6.86x: 기억을 가진 신경망
%=======================================================================
\chapter{MIT 6.86x: 기억을 가진 신경망}
\label{ch:lecture10}
...
\begin{conceptbox}[title={개념 1: 돌림 노래 (Loop)}]
...
\begin{conceptbox}[title={개념 2: 정보의 고속도로와 문지기}]
...
\begin{conceptbox}[title={개념 3: 컨닝 페이퍼 (Cheat Sheet)}]
...
\begin{storybox}[title={Scenario: '메이플스토리 월드' 글로벌 채팅}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 5 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 11: MIT 6.86x: 정답 없는 세계의 질서
%=======================================================================
\chapter{MIT 6.86x: 정답 없는 세계의 질서}
\label{ch:lecture11}
...
\begin{conceptbox}[title={개념 1: 깃발 꽂기 게임}]
...
\begin{conceptbox}[title={개념 2: 평균의 함정과 실제 대표 선출}]
...
\begin{storybox}[title={Scenario: 고래(Whale) 유저와 일반 유저 분류}]
...
%=======================================================================
% Lecture 12: MIT 6.86x: 데이터 압축과 추천의 원리
%=======================================================================
\chapter{MIT 6.86x: 데이터 압축과 추천의 원리}
\label{ch:lecture12}
...
\begin{conceptbox}[title={개념 1: 파일 압축과 해제}]
...
\begin{conceptbox}[title={개념 2: 빈칸 채우기 퍼즐}]
...
\begin{storybox}[title={Scenario: 당신이 아직 안 본 '명작' 찾기}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 4 (Part B) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 13: MIT 6.86x: 시행착오의 과학
%=======================================================================
\chapter{MIT 6.86x: 시행착오의 과학}
\label{ch:lecture13}
...
\begin{conceptbox}[title={개념 1: 세상을 정의하는 5가지 요소}]
...
\begin{conceptbox}[title={개념 2: 가치(Value)의 재귀적 정의}]
...
\begin{storybox}[title={Scenario: 모바일 RPG 자동 사냥}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 5 (Part A) 핵심 요약}]
\begin{itemize}
...
%=======================================================================
% Lecture 14: MIT 6.86x: 경험으로 완성하는 지능
%=======================================================================
\chapter{MIT 6.86x: 경험으로 완성하는 지능}
\label{ch:lecture14}
...
\begin{conceptbox}[title={개념 1: 나만의 맛집 리스트 작성}]
...
\begin{conceptbox}[title={개념 2: 단골집 vs 신상 맛집}]
...
\begin{conceptbox}[title={개념 3: 노트를 뇌로 바꾸다}]
...
\begin{storybox}[title={Scenario: 드리프트 장인 AI 만들기}]
...
% 11. 단원 요약 박스
\begin{summarybox}[title={Unit 5 (Part B) 핵심 요약}]
\begin{itemize}
